      ...
      <br><br><br><br><br><div class="container" data-aos="fade-up">
        ...
        <table border="1" class="table text-center">
          ...
          <tr>
            ...
            <td>
              <a href="hapus_jadwal.php?id=<?=$d['id'];?>"><button class="btn btn-dark">HAPUS</button></a>
              <a href="edit_jadwal.php?id=<?=$d['id'];?>"><button class="btn btn-dark">EDIT</button></a>
            </td>
          </tr>
          <?php } ?>
          </tbody>
        </table>
        <center><a href="tambah_jadwal.php"><button class="btn btn-dark btn-lg btn-block">TAMBAH DATA</button></a></center>
      </div>
